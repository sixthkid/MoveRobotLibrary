...
public class TestMoveMotors extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        waitForStart();
        move.Drive(50, 1000, MoveMotors.Direction.FORWARD);
        C.StopFor(1000);
        move.Drive(50, 1000, MoveMotors.Direction.RIGHT);
        C.StopFor(1000);
        move.Drive(50, 1000, MoveMotors.Direction.LEFT);
        C.StopFor(1000);
        move.Drive(50, 1000, MoveMotors.Direction.BACKWARD);
